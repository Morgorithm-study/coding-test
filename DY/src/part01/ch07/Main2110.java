...
public class Main2110 {
    public static void main(String[] args) throws IOException {
        ...
        while (low <= high) {
            int middle = (low + high) / 2; // 최소 거리 설정
            ...
            if (cnt < M) { // 설치된 공유기 수가 가지고 있는 공유기의 수보다 적으면
                high = middle - 1; // upper bound 내림으로써 최소 거리 줄인다.
                continue;
            }
            //설치된 공유기 수가 가지고 있는 공유기 수보다 크다면
            low = middle + 1; // lower bound 올림으로써 최소 거리 늘린다.
        }
